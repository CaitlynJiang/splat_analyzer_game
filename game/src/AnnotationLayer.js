...
export class AnnotationLayer {
  constructor(sceneManager, hooks = {}) {
    ...
    this.hooks = hooks;
    // Game mode: labels stay hidden until the player has named the object.
    this.isVisible = hooks.isVisible ?? (() => true);
    this.objects = [];
  ...
  _update(camera) {
    ...
    for (const entry of entries) {
      ...
      obj.marker.suppress(
        !this.isVisible(obj.annotation) || hiddenByBox || hiddenByOverlap
      );
    }
  }
}
